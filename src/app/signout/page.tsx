            ...
            <section>
                <div className="font-bold font-roboto grid h-screen grid-cols-2">
                    <div className="justify-center pt-20 p-8 object-contain flex space-y-4 bg-black flex-col h-screen ">
                        <div className="text-white font-roboto font-bold text-center"> You have successfully signed out! </div>
                        <Link href="/login">
                          <Button className=" font-roboto font-bold ml-60" variant="secondary">Log back in</Button>
                        </Link>
                    </div>
